...
F = [0 1.0 1.5 2.0 2.5 3.0 3.5 4.0 5.0]' .* k; % ненормированная сила
F_norm = F ./ w; % нормированная сила

Fi_norm = ([0 0.66 0.93 1.18 1.38 1.5 1.6 1.67 1.79] + 0.001)'; % нормированный поток
Fi = Fi_norm.*0.01; % ненормированный поток

% ---------------------------------------------------------
% нормированный случай
...
plot(Fi_norm, F_norm,'b*', Fi_norm, P1, 'r--', Fi_norm, P2, 'g-.');
